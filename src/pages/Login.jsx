            ...
            <div className="w-full max-w-md relative z-10 transition-all duration-500">
                <div className="backdrop-blur-2xl bg-white/[0.02] p-6 sm:p-10 rounded-[2.5rem] border border-white/[0.05] shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        {/* Login Method Toggle */}
                        <div className="flex gap-2 mb-8 bg-black/40 p-1 rounded-2xl border border-white/[0.05]">
                            <button
                                type="button"
                        ...
                        {/* Email Login Form */}
                        {loginMethod === 'email' && (
                            <form onSubmit={handleEmailLogin} className="space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        ...
                        {/* Phone Login Form */}
                        {loginMethod === 'phone' && (
                            <form onSubmit={handlePhoneLogin} className="space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                <div className="space-y-1.5">
                                    <label className="block text-xs font-medium text-white/70 ml-1">Phone Number</label>
                                    <div className="flex relative">
                                        <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center gap-2 text-white/50 text-sm font-medium z-10">
                                            <span>+91</span>
                                        ...
                                        <input
                                            ...
                                            required
                                            maxLength={10}
                                            className="w-full bg-black/40 pl-16 pr-4 py-3.5 rounded-2xl border border-white/[0.08] text-white placeholder:text-white/20 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/50 transition-all font-light tracking-wide"
                                        />
                                    </div>
                                </div>
                                <div className="space-y-1.5 relative">
                        ...
                        <div className="mt-4 text-center">
                            <Link to="/" className="text-xs text-white/30 hover:text-white/70 transition-colors flex items-center justify-center gap-1.5 focus:outline-none">
