                    ...
                    <div className="relative z-10">
                        ...
                        <form onSubmit={handleSignup} className="space-y-4">
                            <div className="space-y-1.5">
                                <label className="block text-xs font-medium text-white/70 ml-1">Full Name</label>
                                <input
                                    type="text"
                                    value={name}
                            ...
                            <div className="space-y-1.5 relative">
                                <label className="block text-xs font-medium text-white/70 ml-1">Confirm Password</label>
                                <input
